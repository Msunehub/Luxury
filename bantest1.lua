...
Notification.new("<Color=Orange>Matsune Hello You<Color=/>"):Display()
wait(0.5)
repeat
    wait()
until game.Players.LocalPlayer
--main
local ui_link = "https://raw.githubusercontent.com/Msunehub/uimatsune/main/matsuneuiblox.lua"
local a = loadstring(game:HttpGet(ui_link))()
local a = a:Window("Blox Fruit Update 21")
local HomePage = a:Tab("Welcome", "rbxassetid://15712776421")
local Set = a:Tab("Settings", "rbxassetid://15712776421")
local Main = a:Tab("General", "rbxassetid://15712776421")
local Farm = a:Tab("Item Quest", "rbxassetid://15712776421")
local Stats = a:Tab("Status", "rbxassetid://15712776421")
local Race = a:Tab("Race V4", "rbxassetid://15712776421")
local Event = a:Tab("Sea Event", "rbxassetid://15712776421")
local Tele = a:Tab("World Teleport", "rbxassetid://15712776421")
local Player = a:Tab("Local Player", "rbxassetid://15712776421")
local DemonFruit = a:Tab("Devil Fruit", "rbxassetid://15712776421")
local Raid = a:Tab("Dungeon", "rbxassetid://15712776421")
local Esp = a:Tab("Esp blox", "rbxassetid://15712776421")
local Shop = a:Tab("Shopee", "rbxassetid://15712776421")
local Misc = a:Tab("Misc", "rbxassetid://15712776421")

HomePage:Seperator("Matsune Hub")
...
spawn(function()
    ...
    Set:Toggle("Walk on Water",true,function(value)
        _G.WalkWater = value
    end)    
    spawn(function()
			while task.wait() do
...
Set:Toggle("Turn On V4 Race",false,function(value)
...
Farm:Toggle("Auto Farm Chest",false,function(value)
 AutoFarmChest = value
...
Farm:Toggle("Auto Farm Chest Mirage island",false,function(value)
...
Farm:Toggle("Auto Chest Bypass90% kick",false,function(vu)
	_G.GrabChested = vu
end)
...
Farm:Toggle("Auto Chest Stop Found First of darkness",_G.STP,function(vu)
	Grab_Chest = vu
...
Farm:Toggle("Auto Farm Chest Hop",_G.AutoFarmChest_Hop,function(value)
...
Race:Toggle("Kill Player [no skill]",false,function(value)
...
Race:Toggle("Auto Kill Player [spam kill]", false, function(value)
...
Event:Toggle("Auto Quest Shipwright Teacher [Kill Shark 20]",_G.GetQuaetRepia,function(value)
